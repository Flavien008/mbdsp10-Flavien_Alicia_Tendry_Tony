...
function sort(countries: HomeModel[]): HomeModel[] {
  return countries;
}

function matches(country: HomeModel, term: string, pipe: PipeTransform) {
  return country.id.toLowerCase().includes(term.toLowerCase())
    || country.title.toLowerCase().includes(term.toLowerCase())
    || country.name.toLowerCase().includes(term.toLowerCase())
    || country.currentbid.toLowerCase().includes(term.toLowerCase())
    || country.bid.toLowerCase().includes(term.toLowerCase())
}
...
export class HomeService {
  ...
  private _countries$ = new BehaviorSubject<HomeModel[]>([]);
